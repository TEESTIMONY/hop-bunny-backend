...
class Game {
    ...
    gameOver() {
        ...
        if (window.uiManager && window.uiManager.auth.isLoggedIn()) {
            console.log('Submitting score to leaderboard:', this.score);
            window.uiManager.submitScore(this.score);
        } else {
            console.log('User not logged in, score not submitted to leaderboard');
        }
